...
\text{В ходе исследования выяснилось, что число войн с заполненным полем "coordinate location" всего 5 процентов, что на 38% меньше, чем битв; из этого следуют что гипотеза, приведённая в начале полностью подтвердилась.}

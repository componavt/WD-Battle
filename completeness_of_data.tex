...
\textbf{Обозначения.} Будем говорить, что объект обладает \italic{точной геопривязкой}, если у него есть заполненное свойство "coordinate location" с указанием долготы и широты места.

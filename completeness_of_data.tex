...
\text{В ходе исследования выяснилось, что число войн с заполненным полем "coordinate location" всего 5х (%) процентов, что на 38 процентов меньше, чем битв; из этого следуют что гипотеза, приведённая в начале полностью подтвердилась.}

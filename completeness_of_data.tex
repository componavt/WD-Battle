...
\begin{itemize}
    \item Английская википедия по результатам поиска выдаёт 77 подкатегорий \href{https://commons.wikimedia.org/wiki/Category:Battles_by_country}{битв по страна}.

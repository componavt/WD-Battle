...
\textbf{Определение 1.} Будем говорить, что объект обладает \italics{точной геопривязкой}, если у него есть заполненное свойство "coordinate location" с указанием долготы и широты места.

\textbf{Определение 2.}Объект обладает \italics{геопривязкой}, если у него есть заполненное свойство "location" с названием места, например, город, деревня, остров.

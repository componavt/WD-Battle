...
\textbf{Определение 23.}Объект обладает \textit{геопривязкой}, если у него есть заполненное свойство "location" с названием места, например, город, деревня, остров.

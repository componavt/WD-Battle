...
\textbf{Определение 1.} Будем говорить, что объект обладает \textit{точной геопривязкой}точной геопривязкой, если у него есть заполненное свойство "coordinate location" с указанием долготы и широты места.

...
<br><br>
Cписок войн без точной геопривязки, но c указаybtv "coordinate location" того объекта, который указан в поле "location": [https://query.wikidata.org/#%23List%20of%20war%20with%20unfilled%20property%20%27location%27%20%0A%23defaultView%3AMap%0ASELECT%20%3FwarLabel%20%3Flocation%20%3F_coordinate_location%0AWHERE%0A%7B%0A%20%20%3Fwar%20wdt%3AP31%20wd%3AQ198.%20%23instance%20of%20war%0A%20%20%3Fwar%20wdt%3AP276%20%3Flocation%20%23display%20location%0A%20%20FILTER%20NOT%20EXISTS%20%7B%20%3Fwar%20wdt%3AP625%20%5B%5D%20%7D%20%23if%20property%20location%20is%20unfilled%0A%20%20OPTIONAL%20%7B%20%3Flocation%20wdt%3AP625%20%3F_coordinate_location.%20%7D%0A%20%20SERVICE%20wikibase%3Alabel%20%7B%20bd%3AserviceParam%20wikibase%3Alanguage%20%22en%22%7D%0A%7D SPARQL query] 166 Results
<source lang="SPARQL">
...
<br><br>
Подводя итоги исследования, число битв с заполненным полем  "coordinate location" составило 4628, а войн всего 35.<br>
Число битв без точной геопривязки 6244, а войн 744.<br>
Число битв без точной геопривязки, но с полем location 1073, а войн 165.<br>
Число битв без точной геопривязки, но с полем location, указывающим на такой объект, у которого есть точная геопривязка 1087, а войн 166.<br>
Также из произведённого исследования стало понятно, что число войн и с геопривязкой и без геопривязки гораздо меньше, чем битв; из этого следуют что гипотеза, приведённая в начале исследования полностью подтвердилась.
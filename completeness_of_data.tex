...
Обозначения. Будем говорить, что объект обладает точной геопривязкой, если у него есть заполненное свойство "coordinate location" с указанием долготы и широты места.
Гипотеза. У войн будет меньше указано координат, поскольку война - это обычно что-то более протяжённое во времени и пространстве.

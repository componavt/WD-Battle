...
\begin{itemize}
\item{Cписок битв с заполненными данными в поле "coordinate location" (См. Рис~\ref{Fig.1}):}
...
Вывод по рис.1~\rev{}: большинство битв происходило Европе и бассейне Средиземного моря, а также в восточной части Соединённых Штатов Америки.

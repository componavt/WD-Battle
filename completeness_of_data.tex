...
\textit{Подводя итоги исследования:}
\begin{itemize}
\item Число битв с заполненным полем  "coordinate location" составило 4628, а войн всего 35.
\item Число битв без точной геопривязки 6244, а войн 744.
\item Число битв без точной геопривязки, но с полем location 1073, а войн 165.
\item Число битв без точной геопривязки, но с полем location, указывающим на такой объект, у которого есть точная геопривязка 1087, а войн 166.
\end{itemize}
\begin{center}
\begin{tabular}{ccc}
...
Битвы & 4628 & 6244 & 1073 & 1087 \\
Войны& \textbf{0,25-0,50}& размер ФРТ \\
\end{tabular}
\end{center}
\textit{Также  из произведённого исследования стало понятно, что число войн и с геопривязкой и без геопривязки гораздо меньше, чем битв; из этого следуют что гипотеза, приведённая в начале исследования полностью подтвердилась.}

...
\multicolumn{1}{c}{} & \multicolumn{1}{c}{Число} & Заполнено поле "coordinate location" & \multicolumn{1}{c}{} Не заполнено поле "coordinate location" & \multicolumn{1}{c}{}Заполнено поле "location" & \multicolumn{1}{c}{} Заполнено поле "coordinate location" для "location"\\ 

...
\textbf{Определение 3.} \textit{Битва-бомж} - это битва которая не имеет ни точной геопривязки, ни геопривязки.

\textbf{Определение 4.} \textit{Войнк-бомж} - это война которая не имеет ни точной геопривязки, ни геопривязки.
...
\begin{lstlisting}\label{lstlisting1}[language=SPARQL ]
